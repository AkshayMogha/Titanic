...
#for fare
FareNA<-mean(titanic[which(!is.na(Fare)),"Fare"])
titanic[which(is.na(Fare)),"Fare"]<-FareNA
...
survived.1<-length(train[which(Survived==1 & Pclass==1),"PassengerId"])
Pclass1<-length(train[which(Pclass==1),"PassengerId"])
...
survived.2<-length(train[which(Survived==1 & Pclass==2),"PassengerId"])
Pclass2<-length(train[which(Pclass==2),"PassengerId"])
...
survived.3<-length(train[which(Survived==1 & Pclass==3),"PassengerId"])
Pclass3<-length(train[which(Pclass==3),"PassengerId"])
